...
async function ifClasificationNameExists(classification_name){
  try{
    const sql = "SELECT * FROM classification WHERE classification_name = $1 LIMIT 1"
...
module.exports = { registerAccount, checkExistingEmail, addClassificationName, ifClasificationNameExists, addVehicle };
